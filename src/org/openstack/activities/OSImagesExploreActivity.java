...
public class OSImagesExploreActivity extends Activity {
	...
	super.onResume( );
	//String selectedImage = Utils.getStringPreference("SELECTED_OSIMAGE", "", this);
	...
	case DIALOG_LOAD_IMAGES:
	    ...
	    builder.setAdapter(adapter, new DialogInterface.OnClickListener() {
			...
			Utils.putStringPreference( "SELECTED_OSIMAGE", chosenImage, OSImagesExploreActivity.this );
			OSImagesExploreActivity.this.finish();
