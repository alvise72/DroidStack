...
public class SimpleNumberKeyListener extends NumberKeyListener {
 
    private char[] mAccepted;
    private static SimpleNumberKeyListener sInstance;
    ...
    private SimpleNumberKeyListener() {
     ...
     */
    public static SimpleNumberKeyListener getInstance() {
        if (sInstance != null) return sInstance;
 
        sInstance = new SimpleNumberKeyListener();
        return sInstance;
    }
